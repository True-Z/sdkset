...
export class DayjsWrapper<C extends CreateDayjsOption> {
   ...
   *
   * @example
   * useDayjs({ date: '2020-1-1' }).set('year', 2012).set('month', 2).format('YYYY-MM-DD')
   * => '2012-03-01' // 月份为 0 ~ 11
   *
   * @param value 时间数值
   * @param unit 时间单位
   ...
   *
   * @example
   * useDayjs({date: '2012-12-21 00:00:00', convers: 'format'}).add(1, 'day')
   * => '2012-12-22 00:00:00'
   *
   * @param value 时间数值
   * @param unit 时间单位
   ...
   *
   * @example
   * useDayjs({date: '2012-12-21 00:00:00', convers: 'format'}).subtractDate(1, 'day')
   * => '2012-12-20 00:00:00'
   *
   * @param value 时间数值
   * @param unit 时间单位
   ...
   *
   * @example
   * useDayjs({date: '2012-12-21 00:00:00', convers: 'format'}).startOf('month')
   * => '2012-12-01 00:00:00'
   *
   * @param unit 时间单位
   */
   ...
   *
   * @example
   * useDayjs({date: '2012-12-21 00:00:00', convers: 'format'}).endOf('month')
   * => '2012-12-31 00:00:00'
   *
   * @param unit 时间单位
   */
